...
extension NavigationExtensoin on BuildContext {
  void navigateto(Widget CategoriesDetailsScreen) {
    Navigator.push(
        this, MaterialPageRoute(builder: (context) => CategoriesDetailsScreen));
  }
}
